...
# Cause-Specific
ics_fit = two.i.CSlassos(data = train, nlambda = 100, 
                     var_time = "time", 
                      var_status = "event")

all_models <- list(
    "cbSCRIP 1SE" = multinom_enet$refitted_models[[which(multinom_enet$lambdagrid == cv_multinom_enet$lambda.1se)]],
    "cbSCRIP" = multinom_enet$refitted_models[[which(multinom_enet$lambdagrid == cv_multinom_enet$lambda.min)]],
...
data_brier <- all_scores$Brier$score %>%
