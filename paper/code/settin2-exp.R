...
for (i in 1:sims) {
    ...
    beta1[nu_ind] <- c(rep(1, num_true/4), rep(0, num_true/4), rep(1, num_true/4), rep(0, num_true/4))
    beta2[nu_ind] <- c(rep(0, num_true/4), rep(1, num_true/4), rep(0, num_true/4), rep(1, num_true/4))
    ...
    sim.data <- cause_hazards_sim(n = n, p = p, 
                                  ...
                                  h1 = 0.55, h2 = 0.35, gamma1 = 1.5, gamma2 = 1.5, exchangeable = FALSE)
