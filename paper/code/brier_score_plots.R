...
#Generate data
i=1
data <- cbSCRIP:::gen_data(n = 400, p = 300, num_true = 20, setting = 1, iter = 123)
...
#----------------------------------
# try a smaller lambda, within 2SE
...
if (length(lambdas_2SEless)) {
    # smallest lambda within 2SE window  → least penalization
...
# Fit model with smaller lambda (min + 1SE)
...
# DO NOT RUN
#For lambda.min
# res_cb_min1 <-varsel_perc(fit_val_min$fit.min$coefficients[1:p, 1], 
#                           beta1)
# 
...
png(filename = "paper/figs/brier_setting1.png", res = 300, height = 12, width = 20, units = "cm") 
...
print(plot2) 
ggsave("paper/figs/brier_setting1.png", plot2,
