...
# plot(model)
# 
# model$models_info[[1]]$convergence_pass
# map_df(model$coefficients, 
#     ~varsel_perc(.[1:p, 1], 
#                  beta1)) |> 
...
# plot(model2)
# 
# model2$models_info[[1]]$convergence_pass
# map_df(model2$coefficients, 
#        ~varsel_perc(.[1:p, 1], 
#                     beta1)) |> 
#     ggplot(aes(1-Specificity, Sensitivity)) +
#     geom_line()
...
# cb_data <- fit_val_min$cb_data
# coef_matrix <- fit_val_min$fit.min$coefficients
...
#     
# model1 <- fit_cb_model(cb_data = cb_data,
#                            lambda = 0,
#                            maxit = 5000,
#                        lr_adj = 100
#                        )
# model1$convergence_pass
# model1$coefficients |> View()
# model1$cb_data <- cb_data
# class(model1) <- "penalizedCompRisk"

# briercasebase <- Score(list("Case-base" = model1),
#                     data = test,
