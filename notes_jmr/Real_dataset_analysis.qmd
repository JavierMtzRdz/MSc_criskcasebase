...
source(here(#"MSc_criskcasebase",
            "paper","code", "fitting_functionsV3.R"))
...
bladder_fpd1 <- read_delim(here::here("notes_jmr/data/GSE5479_Final_processed_data_1.txt"))
bladder_fpd2 <- read_delim(here::here("notes_jmr/data/GSE5479_Final_processed_data_2.txt"))
...
bladder_hd <- read_xls(here::here("notes_jmr/data/6517200/10780432ccr062940-sup-supplemental_file_1.xls")) %>% 
    clean_names() %>% 
...
1. Análisis sólo con genes. Con (sin penalizar) y sin clínicas. W - 1SE lambda. 
2. Repetitions and interesections.
3. Prediction plots.
```
